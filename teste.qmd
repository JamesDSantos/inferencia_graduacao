...
Portanto, $c$ é o quantil $1-\alpha$ de de $\bar{X}_n|\mu_0\sim N(\mu_0,1/n)$. Os exemplos
...
O primeiro erro implica em problemas com clientes e propaganda negativa da marca. Já o segundo implica apenas no trabalho de rotina do controle de qualidade. Vamos considerar o primeiro como o erro do tipo I. Sendo $\theta$ a probabilidade de produzir uma lâmpada defeituosa, queremos testar
$$H_0:\theta\leq 0,02.$$
...
A estimativa para $\theta$ encontrada foi
$$\hat{\theta}_{500}=\sum_{i=1}^{500}\frac{x_i}{500}=\frac{15}{500}=0,03$$
